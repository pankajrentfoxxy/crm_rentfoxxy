...
import { INVENTORY_UMBRELLA_SECTIONS, FLOOR_UMBRELLA_SECTIONS, VENDOR_UMBRELLA_SECTIONS } from '../constants/sectionHierarchy';
...
export const warehouseRoutes = [
  ...
  { path: '/vendor-management/*', element: guardSections(VENDOR_UMBRELLA_SECTIONS, 'view', withLayout(<VendorManagement />)) },

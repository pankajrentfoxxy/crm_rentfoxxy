...
export const operationManagementRoutes = [
  ...
  { path: '/operation-management/sales-orders', element: <Navigate to="/sales-pipeline/sales-orders-rental" replace /> },
  { path: '/operation-management/sales-orders/add', element: <Navigate to="/sales-pipeline/sales-orders-rental" replace /> },

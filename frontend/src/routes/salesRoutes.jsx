...
export const salesRoutes = [
  ...
  },
  {
    ...
    element: (
      <ProtectedRoute
        sections={['sales_quotations', 'sales_orders_doc', 'delivery_challans', 'return_dc', 'delivery_register_management', 'technician_bucket', 'technicians_bucket_list']}
        action="view"
      >
  ...
  { path: '/sales', element: <Navigate to="/sales-pipeline/sales-orders" replace /> },
  ...
  { path: '/lead-orders', element: <Navigate to="/sales-pipeline/sales-orders" replace /> },
  { path: '/customers', element: <Navigate to="/lead-crm/customers" replace /> },
  { path: '/orders', element: <Navigate to="/sales-pipeline/sales-orders" replace /> },
];

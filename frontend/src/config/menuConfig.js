...
export const vendorAccordionChildren = [
  ...
  { label: 'Vendor Return Ticket', path: '/vendor-management/return-ticket', section: 'vendor_return_ticket', sections: ['vendor_return_ticket', 'vendor_return_to_vendor', 'vendor_management'] },
...
export const masterDataMenuItems = [
  ...
  { icon: Package, label: 'Master Vendor Data', path: '/inventory-management/vendor-master-data', section: 'inventory_vendor_master_data' },
  { icon: RefreshCw, label: 'Master Return Data', path: '/inventory-management/return-master-data', section: 'inventory_return_master_data' },
...
export const MENU_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { type: 'vendorAccordion', sections: ['vendor_management', 'vendor_return_to_vendor', 'vendor_return_ticket', 'vendor_repair_dc', 'vendor_repair_dc_dispatch'], section: 'vendor_management', icon: Store, label: 'Vendor Management' },
    ],
  },
  {
    key: 'finance',

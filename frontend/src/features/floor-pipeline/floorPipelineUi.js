...
export const EVENT_ICONS = {
  ...
  dispatch_charger_requested: '🔌',
  dispatch_charger_handed_over: '🔌',
  dispatch_charger_attached: '🔌',
  dispatch_charger_already_with_customer: '🔌',
  dispatch_charger_qc_scanned: '🔌',
  dispatch_charger_return_scanned: '🔌',
  dispatch_charger_returned: '🔌',
  dispatch_charger_cancelled: '🔌',

...
function SalesIndexRedirect() {
  ...
  if (canView('delivery_register_management')) return <Navigate to="delivery-register/in-transit" replace />;
...
export default function SalesPipelineApp() {
  return (
    <Routes>
      ...
      <Route path="delivery-register" element={<Navigate to="in-transit" replace />} />
      <Route path="delivery-register/in-transit" element={g('delivery_register_management', <DeliveryRegisterListPage />)} />
      ...
      <Route path="technician-bucket" element={g('technicians_bucket_list', <TechnicianBucketPage />)} />

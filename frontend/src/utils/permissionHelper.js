...
const LEGACY_ROLE_SECTIONS = {
  ...
  floor_manager: [
    ...
    'parts_approval', 'part_vendor_repair', 'qc_management',
    'inventory_management', 'dispatch', 'customer_inventory',
  ],
  procurement: ['procurement', 'vendor_management', 'parts_procurement', 'parts_inventory', 'part_vendor_repair'],
  qc: ['qc_management'],
  warehouse: [
    'warehouse', 'parts_dashboard', 'parts_inventory', 'parts_approval', 'parts_history', 'part_vendor_repair',
    'parts_discarded', 'scrap_challans', 'inventory_management', 'support_part_challan',
  ],
  dispatch: ['dispatch'],

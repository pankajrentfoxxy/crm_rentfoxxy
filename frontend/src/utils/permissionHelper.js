...
const LEGACY_ROLE_SECTIONS = {
  ...
  manager: [
    ...
    'procurement', 'vendor_management', 'vendor_repair_dc', 'warehouse', 'qc_management',
    'inventory_management', 'dispatch', 'support_tickets', 'support_part_challan', 'support_part_requests', 'customer_inventory', 'teams',
  ...
  warehouse: [
    ...
    'support_warehouse_receipt',
  ],
  dispatch: ['dispatch'],
  support_lead: ['support_tickets', 'support_dashboard', 'customer_inventory', 'support_part_requests', 'support_part_challan', 'support_warehouse_receipt'],
  support_tech: ['support_bucket', 'support_parts_request', 'customer_inventory'],
  ...
  technician: ['support_bucket', 'support_parts_request', 'customer_inventory'],

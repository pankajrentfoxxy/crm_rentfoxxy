...
const LEGACY_STRING_TO_SECTIONS = {
  ...
  parts_access: ['parts', 'parts_inventory', 'part_vendor_repair'],
...
const LEGACY_ROLE_SECTIONS = {
  ...
  admin: [
    ...
    'lead_orders', 'customers', 'manager_dashboard', 'reports', 'parts', 'parts_inventory', 'part_vendor_repair',
  ...
  manager: [
    'dashboard', 'inventory', 'tickets', 'leads', 'sales_orders', 'follow_ups',
    'lead_orders', 'customers', 'manager_dashboard', 'reports', 'reports_access', 'analytics_dashboard', 'reports_export', 'parts', 'parts_inventory', 'part_vendor_repair',
    'procurement', 'vendor_management', 'warehouse', 'qc_management',
  ...
  floor_manager: [
    'dashboard', 'inventory', 'tickets', 'reports', 'reports_access', 'parts', 'parts_inventory', 'part_vendor_repair', 'qc_management',
    'inventory_management', 'dispatch', 'customer_inventory',
  ],
  procurement: ['procurement', 'vendor_management'],
  qc: ['qc_management'],
  warehouse: ['warehouse', 'parts_inventory', 'part_vendor_repair', 'inventory_management'],
  dispatch: ['dispatch'],
  support_lead: ['support_tickets', 'support_dashboard', 'customer_inventory'],
  support_tech: ['support_tickets', 'support_bucket', 'customer_inventory'],
  support_agent: ['support_tickets', 'support_dashboard'],
  support_manager: ['support_tickets', 'support_dashboard', 'support_dispatch', 'support_approvals'],

...
export const SECTION_GROUPS = {
  ...
  'Lead & Sales CRM': [
    ...
    'delivery_register_management', 'delivery_register_otp', 'technician_bucket', 'technicians_bucket_list', 'payment_records',
  ],
  'Vendor & Procurement': ['vendor_management', 'procurement', 'sales_pipeline'],
  'Floor & Quality': ['floor_pipeline', 'floor_tickets', 'chip_level_repair', 'qc_management', 'dispatch_qc', 'tickets'],
  'Inventory & Parts': [

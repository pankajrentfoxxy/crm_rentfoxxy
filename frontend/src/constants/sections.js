...
export const SECTION_LABELS = {
  ...
  support_charges_billing: 'Support — Accounts Charge Billing',
  parts_pricing: 'Parts — Selling Price',
  reports: 'Reports',
...
export const SECTION_GROUPS = {
  ...
  'Vendor & Procurement': ['vendor_management', 'vendor_repair_dc', 'procurement', 'sales_pipeline'],
  ...
  Support: [
    ...
    'support_charges_billing', 'support_technician',
  ],

...
export const SECTION_GROUPS = {
  ...
  'Floor & Quality': ['floor_pipeline', 'floor_tickets', 'floor_ticket_config_edit', 'chip_level_repair', 'qc_management', 'dispatch_qc', 'dispatch_charger', 'pending_inventory', 'diagnosis_failed', 'tickets'],
  Inventory: [

...
/** Sections that grant entry to /vendor-management/* (umbrella route guard). */
export const VENDOR_UMBRELLA_SECTIONS = [
  'vendor_management',
  'parts_procurement',
  'vendor_repair_dc',
...
export const PARTS_PROCUREMENT_UMBRELLA_SECTIONS = VENDOR_UMBRELLA_SECTIONS;

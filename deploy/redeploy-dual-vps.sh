...
# Run: ssh root@187.77.187.213 "curl -sSL https://raw.githubusercontent.com/YOUR_USER/laptop-refurbishment/main/deploy/redeploy-dual-vps.sh | bash"
# Or: curl -sSL https://raw.githubusercontent.com/YOUR_USER/laptop-refurbishment/main/deploy/redeploy-dual-vps.sh | ssh root@187.77.187.213 bash

set -e
VPS_IP="${VPS_IP:-187.77.187.213}"
REPO="${REPO:-pankajrentfoxxy/laptop-refurbishment}"
BRANCH="${BRANCH:-main}"

#!/usr/bin/env node
/**
 * Move specific Carrum Maharashtra laptops from HR (#207) to MH entity (#985).
...
const HR_ID = 207;
const ENTITY_ID = 985;
const ENTITY_NAME = 'CARRUM MOBILITY SOLUTIONS PRIVATE LIMITED(MH)';
const STATE = 'maharashtra';
const REMAP_KEY = 'carrum_mh_remap';

const TTSPLS = [
  'TTSPL6235', 'TTSPL6467', 'TTSPL6271', 'TTSPL6736', 'TTSPL6789', 'TTSPL6605',
  'TTSPL6633', 'TTSPL6626', 'TTSPL6662', 'TTSPL6726', 'TTSPL6244', 'TTSPL6456',
  'TTSPL6494', 'TTSPL6545', 'TTSPL6506', 'TTSPL6159', 'TTSPL6903', 'TTSPL6912',
  'TTSPL4187', 'TTSPL6054', 'TTSPL3006', 'TTSPL3101',
];

const REPORT_PATH = path.join(__dirname, '..', '..', 'reports', 'carrum-mh-laptop-flow.csv');
...
async function main() {
  ...
  console.log(`MH return bucket: ${inReturned.length} returned unit(s) from this batch`);
  console.log(`MH active bucket: ${inActive.length} of ${TTSPLS.length} rented unit(s)`);

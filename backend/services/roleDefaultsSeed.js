...
const ROLE_ROW_DEFAULTS = {
  manager: [
    ...
    ['vendor_management', true, true, false], ['vendor_repair_dc', true, true, false], ['procurement', true, true, false], ['sales_pipeline', true, true, false],
  ...
  warehouse: [
    ['dashboard', false, false, false], ['warehouse', true, true, false], ['guard_gate_checking', true, true, false], ['inventory', false, true, false],

...
const ROLE_ROW_DEFAULTS = {
  manager: [
    ...
    ['sales_quotations', true, true, false], ['sales_orders_doc', true, true, false],
  ...
  sales: [
    ...
    ['sales_quotations', true, false, false], ['sales_orders_doc', true, false, false], ['delivery_challans', false, false, false],

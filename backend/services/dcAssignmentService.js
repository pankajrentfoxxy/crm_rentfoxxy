...
function assigneeMetadataFromBody(body, dispatchMode) {
  ...
  return {
    ...
    bluedart_awb_pdf_path: body.bluedart_awb_pdf_path || null,
...
function assigneeMetadataFromRow(row) {
  return assigneeMetadataFromBody({
    ...
    bluedart_awb_pdf_path: row.bluedart_awb_pdf_path,
...
function metadataEqual(a, b) {
  const keys = [
    'dispatch_mode', 'delivery_person_id', 'courier_name', 'awb_number', 'bluedart_awb_pdf_path',
  ...
  try {
    ...
    await client.query(
      `UPDATE delivery_challan_lines SET
          ...
          courier_name = $4,
          awb_number = $5,
          bluedart_awb_pdf_path = $6,
          courier_tracking_url = $7,
          porter_booking_id = $8,
      ...
      [
        ...
        nextMeta.awb_number,
        nextMeta.bluedart_awb_pdf_path,
